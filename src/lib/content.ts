...
export const labsPreview = [
  {
    title: "AI-Ready Customer Intelligence Blueprint",
    summary:
      "A reference architecture for connecting collection, governance, identity, analytics, activation, and AI-readiness.",
    href: "/industry-labs/ai-ready-customer-intelligence-blueprint",
  },
  {
    title: "Adobe + Google Measurement Parity Framework",
    summary:
      "A model for aligning Adobe Analytics, CJA, GA4, GTM, BigQuery, and reporting definitions.",
    href: "/industry-labs/adobe-google-measurement-parity",
  },
  {
    title: "Real-Time Personalization Architecture",
    summary:
      "A practical view of how RT-CDP, AJO, Adobe Target, analytics, and customer profiles work together.",
    href: "/industry-labs/real-time-personalization-architecture",
  },
  {
    title: "GA4 to BigQuery Analytics Mart",
    summary:
      "A strategy for transforming raw GA4 event data into reliable customer, session, and conversion reporting layers.",
    href: "/industry-labs/ga4-bigquery-analytics-mart",
  },
];
